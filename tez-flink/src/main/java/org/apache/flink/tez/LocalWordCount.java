...
public class LocalWordCount {
	...
	public static void runLocally () throws Exception {
		...
		try {
			DAG dag = createDAG(tezConf, "/Users/kostas/localfs/hamlet.txt",
					"/Users/kostas/localfs/wc", 1, "LocalOrderedWordCount");
